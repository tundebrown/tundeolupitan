      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-2/3">
          ...
          <div className="flex flex-col gap-5 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              Tunde Olupitan is a dynamic full-stack developer driven by a
              passion for creating exceptional digital experiences. With a solid
              foundation in computer science and a peck for blending backend
              expertise with frontend finesse, he specialize in architecting
              robust systems and crafting intuitive user interfaces. Known for
              his innovative spirit and collaborative approach, he thrives on
              pushing the boundaries of technology to deliver impactful
              solutions that inspire and delight users. With a relentless
              commitment to excellence and a dedication to continuous learning,
              he is poised to make a lasting mark in the ever-evolving world of
              ...
              <div className="flex justify-between h-100">
                ...
                <div className="w-1/3">
                  ...
                  <div className="p-3 text-sm italic">
                    ...
                    languages, frameworks such as react js, express js and next
                    js, and mongodb database. allowing me to handle all aspects
                    of the development process from server-side logic to user
                    interface design and creation of RESTful APIs. Additionally, I collaborated closely with
                    cross-functional teams to ensure seamless integration and
                    delivery of high-quality software solutions.{" "}
                  </div>
                  {/* JOB DATE */}
                  <div className="p-3 text-red-950 text-sm font-semibold">
                    April, 2022 - Present
                  </div>
                  {/* JOB COMPANY */}
                  <div className="p-1 rounded bg-red-100 text-xs font-semibold w-fit">
                    Metajest Gaming Studios LLC, UAE
                  </div>
                </div>
                {/* CENTER */}
